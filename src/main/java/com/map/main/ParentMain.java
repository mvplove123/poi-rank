...
public class ParentMain {
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			MultipleInputs.addInputPath(job, new Path(Constants.MYSELF), TextInputFormat.class, ParentMapper.class);
			MultipleInputs.addInputPath(job, new Path(Constants.POI), TextInputFormat.class, ParentMapper.class);
			MultipleInputs.addInputPath(job, new Path(Constants.BUS_POI), TextInputFormat.class, ParentMapper.class);
